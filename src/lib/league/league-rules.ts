 ...
 * | Pick visibility (dual gate) | Opponents tab after week deadline; Results/peer history after week finalize (admins anytime, FR49). Enforce in queries and RSC data, not UI-only. |
